...
- Generated at: 2026-05-19 16:44:34 UTC
...
| --- | --- | --- | --- |
| icij:58029412 | icij:58029412 |  |  |
| NILS PETER GRUT | icij:56068063 |  | seed |
| NILS PETER GRUT | icij:56065757 |  | seed |
...
| --- | --- | --- | --- | --- | --- |
| icij:58029412 | icij 58029412 | true | false | community_only | 1.00 |
| NILS PETER GRUT | nils peter grut | true | false | community_only | 1.00 |

_Exact normalized-name overlap: **0** companies. Full CSV: `data/cluster_64_person_overlap.csv`._

## Person-company role evidence
| Company | Relationship | Role | Leak |
| --- | --- | --- | --- |
| icij:58029412 | registered_address | registered address | Paradise Papers - Malta corporate registry |
| icij:58029412 | registered_address | registered address | Paradise Papers - Malta corporate registry |

_2 edges total. Full CSV: `data/cluster_64_person_company_roles.csv`._

## Recurring infrastructure
### Addresses
| Address | N linked | Source |
| --- | --- | --- |
| 31, BOULEVARD DES MOULINS, MONACO MC 98000 | 2 | Paradise Papers - Malta corporate registry |
...
## Graph paths
See `data/cluster_64_graph_paths.md` for the full extracted-paths report.

## External search queue
`data/cluster_64_external_search_queries.csv` contains **32** queries.
...
| Address reuse rate | 0.333 | high reuse = shared registered office |
