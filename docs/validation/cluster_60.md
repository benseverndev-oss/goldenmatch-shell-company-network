...
- Community ID: **60**
- Human anchor: **nils peter grut**
- Generated at: 2026-05-19 17:14:24 UTC
- Script: `scripts/build_validation_pack.py`
- Threshold: 0.9

### Data gaps / warnings
- ⚠️ dossier file not found at /app/docs/reports/dossiers/nils-peter-grut.md — using parquet only.
...
| --- | --- | --- | --- |
| PSP HOLDING LIMITED | icij:55057986 | mt |  |
| H.R.MARITIME INTERNATIONAL LIMITED | icij:55055270 | mt | seed |
| icij:58058200 | icij:58058200 |  |  |

_Total cluster size: 3_

## nils peter grut dossier summary
_(no dossier file)_

## Company overlap table
| Company | Normalized | In cluster? | In dossier? | Match type | Conf |
| --- | --- | --- | --- | --- | --- |
| H.R.MARITIME INTERNATIONAL LIMITED | hrmaritime international | true | false | community_only | 1.00 |
| icij:58058200 | icij 58058200 | true | false | community_only | 1.00 |
| PSP HOLDING LIMITED | psp holding | true | false | community_only | 1.00 |

_Exact normalized-name overlap: **0** companies. Full CSV: `data/cluster_60_person_overlap.csv`._

## Person-company role evidence
| Company | Relationship | Role | Leak |
| --- | --- | --- | --- |
| H.R.MARITIME INTERNATIONAL LIMITED | officer_of | director of | Paradise Papers - Malta corporate registry |
| H.R.MARITIME INTERNATIONAL LIMITED | officer_of | judicial representative of | Paradise Papers - Malta corporate registry |
| H.R.MARITIME INTERNATIONAL LIMITED | officer_of | legal representative of | Paradise Papers - Malta corporate registry |

_3 edges total. Full CSV: `data/cluster_60_person_company_roles.csv`._

## Recurring infrastructure
### Addresses
| Address | N linked | Source |
| --- | --- | --- |
| CENTRAL BUSINESS CENTRE - ROOM1, LEVEL 1 - SUITE 2, MDINA ROAD, ZEBBUGZBG 9015, MALTA | 2 | Paradise Papers - Malta corporate registry |

### Officers / directors
| Officer | N linked | Roles |
| --- | --- | --- |
| DARMANIN CAUCHI & CO | 2 | auditor of |
| GEORGE FARRUGIA | 2 | director of;judicial representative of;legal representative of;secretary of |
...
## Graph paths
See `data/cluster_60_graph_paths.md` for the full extracted-paths report.

## External search queue
`data/cluster_60_external_search_queries.csv` contains **32** queries.
...
**Supporting evidence:**
- 2 ICIJ uids share normalized name `nils peter grut` (icij:56065757, icij:56068063).
