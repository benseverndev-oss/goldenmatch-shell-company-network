...
- Generated at: 2026-05-19 17:14:10 UTC
...
| --- | --- | --- | --- |
| AB YACHTING LTD | icij:55081330 | mt |  |
| icij:58042501 | icij:58042501 |  |  |
| SANTHILL LIMITED | icij:55049793 | mt | seed |
...
| --- | --- | --- | --- | --- | --- |
| AB YACHTING LTD | ab yachting | true | false | community_only | 1.00 |
| icij:58042501 | icij 58042501 | true | false | community_only | 1.00 |
| SANTHILL LIMITED | santhill | true | false | community_only | 1.00 |

_Exact normalized-name overlap: **0** companies. Full CSV: `data/cluster_49_person_overlap.csv`._

## Person-company role evidence
| Company | Relationship | Role | Leak |
| --- | --- | --- | --- |
| SANTHILL LIMITED | officer_of | secretary of | Paradise Papers - Malta corporate registry |

_1 edges total. Full CSV: `data/cluster_49_person_company_roles.csv`._

## Recurring infrastructure
### Addresses
| Address | N linked | Source |
| --- | --- | --- |
| 45/13, STRIAT STREET, VALLETTAVLT 1434, MALTA | 2 | Paradise Papers - Malta corporate registry |

### Officers / directors
| Officer | N linked | Roles |
| --- | --- | --- |
| CATHERINE BAXTER | 2 | director of;judicial representative of;legal representative of;local representative of |
...
## Graph paths
See `data/cluster_49_graph_paths.md` for the full extracted-paths report.

## External search queue
`data/cluster_49_external_search_queries.csv` contains **32** queries.
