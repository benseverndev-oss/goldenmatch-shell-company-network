...
- Generated at: 2026-05-19 17:14:29 UTC
...
| --- | --- | --- | --- |
| FAREX LTD | icij:55048057 | mt |  |
| INVICTUS PROPERTIES SOLUTIONS LIMITED | icij:55065194 | mt | seed |
| icij:58008874 | icij:58008874 |  |  |
...
| --- | --- | --- | --- | --- | --- |
| FAREX LTD | farex | true | false | community_only | 1.00 |
| icij:58008874 | icij 58008874 | true | false | community_only | 1.00 |
| INVICTUS PROPERTIES SOLUTIONS LIMITED | invictus properties solutions | true | false | community_only | 1.00 |

_Exact normalized-name overlap: **0** companies. Full CSV: `data/cluster_67_person_overlap.csv`._

## Person-company role evidence
| Company | Relationship | Role | Leak |
| --- | --- | --- | --- |
| INVICTUS PROPERTIES SOLUTIONS LIMITED | officer_of | director of | Paradise Papers - Malta corporate registry |
| INVICTUS PROPERTIES SOLUTIONS LIMITED | officer_of | judicial representative of | Paradise Papers - Malta corporate registry |
| INVICTUS PROPERTIES SOLUTIONS LIMITED | officer_of | legal representative of | Paradise Papers - Malta corporate registry |

_3 edges total. Full CSV: `data/cluster_67_person_company_roles.csv`._

## Recurring infrastructure
### Addresses
| Address | N linked | Source |
| --- | --- | --- |
| 13 CURATE FENECH STREET, BIRZEBBUGIABBG2032, MALTA | 2 | Paradise Papers - Malta corporate registry |
...
## Graph paths
See `data/cluster_67_graph_paths.md` for the full extracted-paths report.

## External search queue
`data/cluster_67_external_search_queries.csv` contains **32** queries.
