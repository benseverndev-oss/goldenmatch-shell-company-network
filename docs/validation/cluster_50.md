...
- Generated at: 2026-05-19 17:21:30 UTC
...
| --- | --- | --- | --- |
| PETER KEVIN PERRY | icij:56056705 |  | seed |
| PETER KEVIN PERRY | icij:56056803 |  | seed |
| icij:58031372 | icij:58031372 |  |  |
...
| --- | --- | --- | --- | --- | --- |
| icij:58031372 | icij 58031372 | true | false | community_only | 1.00 |
| PETER KEVIN PERRY | peter kevin perry | true | false | community_only | 1.00 |

_Exact normalized-name overlap: **0** companies. Full CSV: `data/cluster_50_person_overlap.csv`._

## Person-company role evidence
| Company | Relationship | Role | Leak |
| --- | --- | --- | --- |
| icij:58031372 | registered_address | registered address | Paradise Papers - Malta corporate registry |
| icij:58031372 | registered_address | registered address | Paradise Papers - Malta corporate registry |

_2 edges total. Full CSV: `data/cluster_50_person_company_roles.csv`._

## Recurring infrastructure
### Addresses
| Address | N linked | Source |
| --- | --- | --- |
| 52 BARRULE PARK, RAMSEY IM8 2BP | 2 | Paradise Papers - Malta corporate registry |
...
## Graph paths
See `data/cluster_50_graph_paths.md` for the full extracted-paths report.

## External search queue
`data/cluster_50_external_search_queries.csv` contains **32** queries.
